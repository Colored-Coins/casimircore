...
function connect_paths (router, method, controllers_path, auth, routes, private_area) {
...
module.exports = function (routes, controllers_path, auth, router) {
  router = router || express.Router()
  for (var method in routes) {
    connect_paths(router, method.toLowerCase(), controllers_path, auth, routes[method].Public)
    connect_paths(router, method.toLowerCase(), controllers_path, auth, routes[method].Private, true)
  }
  console.log('----------------------------------------------------------------------------------')
