...
function connect_paths (router, method, controllers, auth, routes, private_area) {
  //  Private API
  var string = private_area ? 'Private' : 'Public'
  console.log('----------------------------------' + string + ' ' + method.toUpperCase() + ' API---------------------------------')
  for (var path in routes) {
    ...
    // if (optional_params) params = params.concat(optional_params)
    ...
    console.log('Path: ' + rest_path + ' ,Function: ' + function_name)
    router[method](path, middlewares)
    router[method](rest_path, middlewares)
  }
}

module.exports = function (routes, controllers, auth) {
  console.log('----------------------------------------------------------------------------------')
  console.log('----------------------------------------------------------------------------------')
  console.log('--------------------------------                    ------------------------------')
