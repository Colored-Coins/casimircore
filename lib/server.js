...
module.exports = function (properties) {
  ...
  var proxies = properties.modules && properties.modules.proxies
  ...
  if (proxies) {
    proxies.forEach(function (proxy) {
      app.use(proxy.orgPath, express_proxy(proxy.dstHost, {
        preserveHostHdr: true,
        forwardPath: function(req, res) {
          // console.log("forward to:", proxy.dstHost + proxy.dstPath + urlParser.parse(req.url).path)
          return proxy.dstPath + urlParser.parse(req.url).path
        },
