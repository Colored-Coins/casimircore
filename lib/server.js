...
module.exports = function (properties) {
  ...
  var piwik = properties.modules && properties.modules.piwik
  ...
  if (cookies_secret) {
    ...
    console.log('You can\' use Cookies - :(')
  }
  ...
  piwik && app.use(piwik)                                 // Piwik analytics middleware
  ...
  if (sockets === 'true') {
    ...
    server.io_server.on('connection', function (socket) {
      server.sockets = true
      console.log('user conneced to scoket with id: ' + socket.id)
