...
module.exports = function (settingsDir) {
  ...
  if (properties_default.db || process.env.DB_HOST || process.env.DB_URI) {
    ...
    console.log('process.env.DB_OPTIONS', process.env.DB_OPTIONS)
    console.log('process.env.DBOPTIONS', process.env.DBOPTIONS)
    console.log('properties_default.db.options', properties_default.db.options)
