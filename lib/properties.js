...
module.exports = function (settingsDir) {
  ...
  properties_default.JWT.jwtTokenSecret = process.env.JWTTOKENSECRET || properties_default.JWT.jwtTokenSecret
  ...
  properties_default.logentries.api_key = process.env.LOG_API_KEY || properties_default.logentries.api_key
